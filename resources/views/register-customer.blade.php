...
@section('section')
    <section class="w-full">
        <div class="box-login w-[550px] mx-auto bg-[#b5b4b0] mt-24 p-6">
            <h1 class="font-bold text-center mb-7 text-xl">Registrasi Customer</h1>
            <form action="/registercustomer" method="POST">
                ...
                <table class="table-auto mx-auto mb-5">
                    <tbody>
                        <tr class="mb-2 pb-2">
                            <td class="pb-2">
                                <label for="" class="font-bold">No. Whatsapp</label>
                            </td>
                            <td class="pb-2">
                                <input type="text"
